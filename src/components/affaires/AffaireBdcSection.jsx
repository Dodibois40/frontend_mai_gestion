...
const AffaireBdcSection = ({ affaire, categoriesAchat, onDataChanged }) => {
  ...
  // Fonction pour créer une demande de BDC
  const handleCreateDemande = () => {
    setShowCreationModal(false);
    setEditingBdc(null); // S'assurer qu'on crée un nouveau BDC
    setShowModal(true); // Ouvrir le formulaire de création
  };
