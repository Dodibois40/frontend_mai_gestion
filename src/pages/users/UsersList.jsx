                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          ...
                          <div className="ml-4">
                            ...
                            >
                              {/* Noms d'utilisateurs en couleurs vives aléatoires */}
                        ...
                        <div className="space-y-1">
                          {user.tarifHoraireVente > 0 ? (
                            <div className="text-sm font-medium text-green-600">
                              💸 {formatTarif(user.tarifHoraireVente)}
                            </div>
                          ) : user.tarifHoraireCout > 0 ? (
                            <div className="text-sm font-medium text-red-600">
                              💰 {formatTarif(user.tarifHoraireCout)}
                            </div>
                          ) : user.tarifHoraireBase > 0 ? (
                            <div className="text-sm font-medium text-yellow-600">
                              ⚠️ {formatTarif(user.tarifHoraireBase)}
                            </div>
                          ) : (
                          ...
                          {user.tarifHoraireVente > 0 && user.tarifHoraireCout > 0 && (
                            <div className="text-xs text-gray-500">
                              Coût: {formatTarif(user.tarifHoraireCout)}
                            </div>
                          )}
                        </div>
                      </td>
