...
<<<<<<< HEAD
              ...
              <button
                ...
                className="inline-flex items-center px-3 py-2 text-sm font-medium text-purple-700 bg-purple-50 border border-purple-200 rounded-lg hover:bg-purple-100 hover:text-purple-800 transition-all duration-200 ease-in-out shadow-sm hover:shadow-md active:scale-95 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-1 dark:bg-purple-900/20 dark:text-purple-300 dark:border-purple-700 dark:hover:bg-purple-900/40"
                title="Améliorations CRM - Signaler bugs et suggestions"
              >
                <IconBug size={16} className="mr-2" />
                <span className="hidden sm:inline">Améliorations</span>
