...
INSERT INTO "new_users" ("actif", "avatar", "blockedUntil", "couleurPlanning", "createdAt", "dateEmbauche", "disponiblePlanning", "email", "failedLoginAttempts", "forcePasswordChange", "id", "isBlocked", "lastLoginAt", "lastPasswordChange", "nom", "passwordHash", "prenom", "role", "statutContractuel", "supprime", "supprimeLe", "tarifHoraireBase", "telephone", "twoFactorEnabled", "twoFactorSecret", "updatedAt") SELECT "actif", "avatar", "blockedUntil", "couleurPlanning", "createdAt", "dateEmbauche", "disponiblePlanning", "email", "failedLoginAttempts", "forcePasswordChange", "id", "isBlocked", "lastLoginAt", "lastPasswordChange", "nom", "passwordHash", "prenom", "role", "statutContractuel", "supprime", "supprimeLe", "tarifHoraireBase", "telephone", "twoFactorEnabled", "twoFactorSecret", "updatedAt" FROM "users";
DROP TABLE "users";
